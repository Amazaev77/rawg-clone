...
const StarIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
...
const FireIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 26">
...
const NextIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16">
...
const CalendarIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    width="19"
    height="14"
...
const CupIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 22">
...
const BarIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    ...
    viewBox="0 0 24 16"
  >
    <path fillRule="evenodd" d="M0 4h6v12H0V4zm9-4h6v16H9V0zm9 6h6v10h-6V6z" />
  </svg>
);
const CrownIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 16">
...
const ControllerIcon: FC<IIconComponentProps> = (
  props: IIconComponentProps
) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
...
const ArrowDownIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    ...
    viewBox="0 0 16 20"
  >
    <path d="M15.966 7.05h-4.558V0H4.57v7.05H.01l7.978 8.226 7.977-8.225zM.011 17.628v2.35h15.955v-2.35H.011z" />
  </svg>
);
const FolderIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="20"
...
const CommentIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    width="21"
    height="18"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M10.5 0C4.7 0 0 3.62 0 8.086c0 2.19 1.132 4.18 2.97 5.635-.106 1.485-.463 3.3-1.497 4.279 2.058 0 4.161-1.29 5.49-2.3 1.106.304 2.295.471 3.537.471 5.8 0 10.5-3.617 10.5-8.085C21 3.619 16.3 0 10.5 0z" />
  </svg>
);
const GenresIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="18"
...
const CreatorsIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  ...
  >
    <g fill="none">
      ...
      <path d="M.074 17.264c-.001-.194-.003-.055 0 0zm15.349.113c.003-.045 0-.312 0 0z" />
      <path d="M16.354 16.994c-.08-4.797.228-4.31-4.83-5.176 0 0-1.682.86-3.342.86-1.66 0-3.341-.86-3.341-.86-5.004.856-4.736.349-4.829 5.02-.007.381-.01.401-.012.357v.504S1.206 20 8.183 20s8.181-2.3 8.181-2.3v-.374c0 .028-.003-.025-.009-.332z" />
    </g>
  </svg>
);
const TagsIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="16"
    ...
    viewBox="0 0 16 18"
  >
    <path d="M15.467 7.317h-2.745l-.69 3.141h2.72l-.534 2.78h-2.732L10.485 18H7.597l1.001-4.762H5.554L4.553 18H1.678l1.002-4.762H0l.546-2.78H3.24l.676-3.14H1.25l.546-2.756h2.68L5.437 0h2.875L7.35 4.562h3.043L11.356 0h2.888l-.963 4.562H16l-.533 2.755zm-8.82-.237l-.767 3.628h3.395l.793-3.628h-3.42z" />
  </svg>
);
const DevelopersIcon: FC<IIconComponentProps> = (
  props: IIconComponentProps
) => (
  <svg
    {...props}
...
const PublishersIcon: FC<IIconComponentProps> = (
  props: IIconComponentProps
) => (
  <svg
    {...props}
    ...
    viewBox="0 0 18 20"
  >
    <path d="M0 16.843V3.159L12.57 0v20L0 16.843zm15.02-14.32h2.822v15.675H15.02V2.524z" />
  </svg>
);
const PcIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
...
const PlaystationIcon: FC<IIconComponentProps> = (
  props: IIconComponentProps
) => (
  <svg {...props} viewBox="0 0 21 16" xmlns="http://www.w3.org/2000/svg">
...
const XboxIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
...
const NintendoIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 16">
    <path
      fillRule="evenodd"
...
const IosIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 18">
    <path d="M9.538 0H1.651C.896 0 .287.587.287 1.31v15.368c0 .723.61 1.31 1.364 1.31h7.887c.754 0 1.364-.587 1.364-1.31V1.31c0-.723-.61-1.31-1.364-1.31zm-5.89.796h3.894c.098 0 .178.14.178.315 0 .174-.08.316-.178.316H3.648c-.099 0-.177-.142-.177-.316 0-.174.078-.315.177-.315zm1.947 15.898c-.48 0-.87-.375-.87-.836 0-.462.39-.835.87-.835s.87.373.87.835c0 .461-.39.836-.87.836zM9.88 13.83H1.31V2.21h8.57v11.62z" />
  </svg>
);
const AndroidIcon: FC<IIconComponentProps> = (props: IIconComponentProps) => (
  <svg
    {...props}
    className="SVGInline-svg discover-sidebar__icon-svg"
    viewBox="0 0 16 18"
    xmlns="http://www.w3.org/2000/svg"
  >
